...
if TYPE_CHECKING:
    ...
    from pis.config.models import BaseTaskDefinition, Settings
...
def settings() -> 'Settings':
    ...
    See :class:`pis.config.models.Settings`.

    :return: The settings object.
    :rtype: pis.config.models.Settings
    """
    if _config is None:
        init_config()
...
def scratchpad() -> Scratchpad:
    ...
    :return: The scratchpad.
    :rtype: pis.config.scratchpad.Scratchpad
    """
